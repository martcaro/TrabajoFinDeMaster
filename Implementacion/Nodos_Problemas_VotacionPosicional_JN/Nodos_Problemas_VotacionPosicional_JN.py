...
def getWeights(row, graph):
    """
        Funcion que calcula la suma de todos los valores de jn de todos los nodos con los que tiene jn
    """
    ...
    for elem in neighbors_list:
        ...
        suma = suma + jn_value(problem, elem, graph)
...
def getPonderaciones(row, graph):
    ...
    for elem in neighbors_list:
        ...
        peso_enlace = jn_value(problem, elem, graph)
