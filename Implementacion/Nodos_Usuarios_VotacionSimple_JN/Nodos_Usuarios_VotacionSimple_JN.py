...
print(jn_df[jn_df['jn']>0]) # para probar que esta correcto el df
...
def getSimilarUsers(row, jn_df):
    """
        Funcion que devuelve la lista de los usuarios similares del usuario de la fila: aquellos que tienen un valor jn
        mayor a cero
    """
    # print(row['user_id'])
