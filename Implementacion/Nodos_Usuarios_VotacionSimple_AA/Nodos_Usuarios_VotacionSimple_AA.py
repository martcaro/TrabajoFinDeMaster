...
print(aa_df[aa_df['aa']>0]) # para probar que esta correcto el df
...
def getSimilarUsers(row, aa_df):
    """
        Funcion que devuelve la lista de los usuarios similares del usuario de la fila: aquellos que tienen un valor AA
        mayor a cero
    """
    # print(row['user_id'])
