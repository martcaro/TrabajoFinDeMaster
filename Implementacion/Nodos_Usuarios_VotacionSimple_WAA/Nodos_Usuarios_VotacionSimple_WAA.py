...
print(waa_df[waa_df['waa']>0]) # para probar que esta correcto el df
...
def getSimilarUsers(row, waa_df):
    """
        Funcion que devuelve la lista de los usuarios similares del usuario de la fila: aquellos que tienen un valor waa
        mayor a cero
    """
    # print(row['user_id'])
...
f = open("C:/hlocal/TFM/vot_simple2", 'a')
